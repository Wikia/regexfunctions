...
if ( function_exists( 'wfLoadExtension' ) ) {
	...
	$wgExtensionMessagesFiles['RegexFunctionsAliases'] = __DIR__ . '/RegexFunctions.alias.php';
	/* wfWarn(
	...
	die( 'This version of the RegexFunctions extension requires MediaWiki 1.25+' );
}
